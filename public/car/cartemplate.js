...
function CreateWheel(position) {
    ...
    wheelMesh.material = _tyreMaterial;
...
function CreateGroundAndWalls() {
    ...
    const checkerboard = new BABYLON.Texture("textures/amiga.png", scene);
